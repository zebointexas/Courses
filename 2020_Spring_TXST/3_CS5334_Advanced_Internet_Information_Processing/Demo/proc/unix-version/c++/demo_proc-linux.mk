...
cpdemo2.o: cpdemo2.pc
	$(PROC) cpool=yes threads=yes cmin=5 cmax=14 cincr=2 iname=$* $(CPDEMO_FLAG)
	$(C2O)
...
ematch_job.o: ematch_job.pc
	$(MAKE) -f $(MAKEFILE) PROCFLAGS="sqlcheck=full user=your_oracle_account_name/your_oracle_account_password@orclfire CPP_SUFFIX=cxx $(PROCPPFLAGS)" PCCSRC=$* I_SYM=include= pc1
...
my_string_class.o: my_string_class.cxx
	$(CPLUSPLUS) -c $(INCLUDE) $*.cxx
...
USERID=your_oracle_account_name/your_oracle_account_password@orclfire
