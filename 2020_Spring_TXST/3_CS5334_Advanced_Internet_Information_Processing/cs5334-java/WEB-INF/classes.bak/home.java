...
public class home extends HttpServlet {
                      ...
                      HttpServletResponse response) throws ServletException, IOException
   {
     ...
     //      ResourceBundle.getBundle("LocalStrings",request.getLocale());
      ...
      out.println(" <center><h2>AdvancedManpower Welcomes You! </h2></center>");
      out.println(" <center>");

      out.println(" <IMG src=\"/AIIPDemos/images/background.gif\" width=\"550\"" +
		      "height=\"180\"  usemap=\"#map1\" border=\"0\"><map name=map1>");
      out.println(" <area shape=\"rect\" coords=\"3,3,215,180\"" +
		      	"href=\"http://phoenix.cs.txstate.edu:8080/AIIPDemos/servlets/jobSearch.html\">");
      out.println(" <area shape=\"rect\" coords=\"310,3, 550,180\"" +
		      "href=\"http://phoenix.cs.txstate.edu:8080/AIIPDemos/servlets/employerLogin.html\">");
      out.println(" </map>");
      ...
      out.println(" <br>");
      out.println(" <b>");
      out.println(" AdvancedManPower.com will assist and challenge you to be where you can be in the 21th centry in the high tech, high competitive, high reward world.");
      out.println(" </b>");
      out.println(" <br>");
      out.println(" <br>");
      out.println(" <br>");
      ...
      out.println(" <td> <A href=\"http://phoenix.cs.txstate.edu:8080/AIIPDemos/servlets/employerLogin.html\">Employers </A>");
      out.println(" <td> <A href=\"http://phoenix.cs.txstate.edu:8080/AIIPDemos/servlets/candidateLogin.html\">Members </A>");
      out.println(" </tr>");
      out.println(" </table>");
      out.println(" </center>");
      out.println(" <br>");
      out.println(" <i>Copyright @2003 AdvancedManPower.com Inc. All rights reserved.");
      out.println(" </body>");
      out.println(" </html>");
      }
