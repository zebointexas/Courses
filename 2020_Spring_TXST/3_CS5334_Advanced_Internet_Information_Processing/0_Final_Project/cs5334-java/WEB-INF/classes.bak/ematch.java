...
public class ematch extends HttpServlet {
	...
	//out.println("<body background=\"/AIIPDemos/images/sky_bg.gif\"" +
	...
	out.println("<A HREF=\"mailto:" + oneColumn + "\">" + oneColumn +
			"</A> <IMG SRC=/AIIPDemos/images/email.gif border=0 align=middle>");
	out.println("</font>");
	out.println("<br>");
	...
	//          ("jdbc:oracle:kprb:@phoenix.cs.txstate.edu:1521:ORCL817","scott", "tiger"); 
	//Connection conn =  
        ...
        throws IOException, ServletException
    {
		...
		//out.println("<td><a href=\"/AIIPDemos/servlets/getjob?id=$count&filename=dummy\"" +
        ...
        throws IOException, ServletException
    {
        ...
        out.println("<tr>");
        out.println("	<td> <A href=\"http://phoenix.cs.txstate.edu:8080/AIIPDemos/jsp/home.jsp\"> Home </A>");
        out.println("	<td> <A href=\"http://phoenix.cs.txstate.edu:8080/AIIPDemos/servlets/jobSearch.html\">Job Search </a>");
        out.println("	<td> <A href=\"/AIIPDemos/servlets/employerLogin.html\">Employers </A>");
        out.println("	<td> <A href=\"/AIIPDemos/servlets/candidateLogin.html\">Members </A>");
        out.println("</tr>");
        out.println("</table>");
        out.println("</center>");
