...
public class home extends HttpServlet {
                      ...
                      HttpServletResponse response) throws ServletException, IOException
   {
     ...
     //      ResourceBundle.getBundle("LocalStrings",request.getLocale());
      ...
      out.println(" <center><h2>DrPengspeng Welcomes You! </h2></center>");
      out.println(" <center>");

      out.println(" <IMG src=\"/peng/images/background.gif\" width=\"550\"" +
		      "height=\"180\"  usemap=\"#map1\" border=\"0\"><map name=map1>");
      out.println(" <area shape=\"rect\" coords=\"3,3,215,180\"" +
		      	"href=\"http://glaciers.cs.txstate.edu:8080/peng/servlets/jobSearch.html\">");
      out.println(" <area shape=\"rect\" coords=\"310,3, 550,180\"" +
		      "href=\"http://glaciers.cs.txstate.edu:8080/peng/servlets/employerLogin.html\">");
      out.println(" </map>");
      ...
      out.println(" <td> <A href=\"http://glaciers.cs.txstate.edu:8080/peng/servlets/employerLogin.html\">Employers </A>");
      out.println(" <td> <A href=\"http://glaciers.cs.txstate.edu:8080/peng/servlets/candidateLogin.html\">Members </A>");
      out.println(" </tr>");
      out.println(" </table>");
      out.println(" </center>");
      out.println(" <br>");
      out.println(" <i>Copyright @2006 DrPengspeng.com Inc. All rights reserved.");
      out.println(" </body>");
      out.println(" </html>");
      }
