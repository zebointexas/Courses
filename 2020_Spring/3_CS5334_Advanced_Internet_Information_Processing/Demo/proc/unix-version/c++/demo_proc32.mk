...
cpdemo2.o: cpdemo2.pc
	$(PROC_32) cpool=yes threads=yes cmin=5 cmax=20 cincr=2 iname=$* $(CPDEMO_FLAG)
	$(C2O_32)
...
ematch_job.o: ematch_job.pc
	$(MAKE) -f $(MAKEFILE) PROCFLAGS="sqlcheck=full user=scott/tiger CPP_SUFFIX=cxx $(PROCPPFLAGS)" PCCSRC=$* I_SYM=include= pc1
...
USERID=scott/tiger
INCLUDE=$(I_SYM). $(I_SYM)$(PRECOMPHOME)public32 $(I_SYM)$(PRECOMPHOME)public $(I_SYM)$(RDBMSHOME)public $(I_SYM)$(RDBMSHOME)demo $(I_SYM)$(PLSQLHOME)public $(I_SYM)$(NETWORKHOME)public

# PRECOMPPUBH32 should be defined in Makefile32
#               as $(I_SYM)$(PRECOMPHOME)public32
# For rest, PRECOMPPUBH32 should be empty as default.
PRECOMPPUBH32=$(I_SYM)$(PRECOMPHOME)public32
